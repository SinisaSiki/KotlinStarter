...
public class StopLogicEngine implements StopEngine {
    ...
    public String debug(String str, float f) {
        ...
        sb.append(str + " ===== " + this.mType + ShellUtils.COMMAND_LINE_END);
        sb.append(str);
        ...
        String str2 = sb.toString() + str + " dur " + this.mStage1Duration + " vel " + this.mStage1Velocity + " pos " + this.mStage1EndPosition + ShellUtils.COMMAND_LINE_END;
