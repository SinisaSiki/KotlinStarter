    ...
    public static void dumpPoc(Object obj) {
        ...
        for (Field field : cls.getFields()) {
            try {
                ...
                if (field.getName().startsWith("layout_constraint") && ((!(obj2 instanceof Integer) || !obj2.toString().equals(Configurator.SCREEN_TIMEOUT_NEVER)) && ((!(obj2 instanceof Integer) || !obj2.toString().equals("0")) && ((!(obj2 instanceof Float) || !obj2.toString().equals(BuildConfig.VERSION_NAME)) && (!(obj2 instanceof Float) || !obj2.toString().equals("0.5")))))) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            for (int i2 = 0; i2 < fields.length; i2++) {
                ...
                try {
                    ...
                    if (field.getName().contains("To") && !obj.toString().equals(Configurator.SCREEN_TIMEOUT_NEVER)) {
    ...
    public static void dumpLayoutParams(ViewGroup.LayoutParams param, String str) {
        ...
        for (Field field : param.getClass().getFields()) {
            try {
                ...
                if (name.contains("To") && !obj.toString().equals(Configurator.SCREEN_TIMEOUT_NEVER)) {
