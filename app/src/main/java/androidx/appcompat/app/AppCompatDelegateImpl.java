    ...
    */
    ...
    public class AutoBatteryNightModeManager extends AutoNightModeManager {
        ...
        AutoBatteryNightModeManager(Context context) {
            super();
            AppCompatDelegateImpl.this = r1;
            this.mPowerManager = (PowerManager) context.getApplicationContext().getSystemService(Configurator.FUNCTION_KEY_SET_POWER);
        }
    ...
    private static Configuration generateConfigDelta(Configuration configuration, Configuration configuration2) {
        ...
        if (configuration2 != null && configuration.diff(configuration2) != 0) {
            ...
            if ((configuration.screenLayout & PropertyID.CODABAR_ENABLE) != (configuration2.screenLayout & PropertyID.CODABAR_ENABLE)) {
                configuration3.screenLayout |= configuration2.screenLayout & PropertyID.CODABAR_ENABLE;
            }
            if (Build.VERSION.SDK_INT >= 26) {
