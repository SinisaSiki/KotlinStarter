...
public class SLE4428Reader2 extends CardReader2 {
    ...
    public byte[] readMainMemory(int i, int i2) throws InvalidParameterException {
        int i3 = i;
        byte[] bArr = null;
        if (i3 < 0 || i3 > 1023 || i2 < 0 || i2 > 1024 || i3 + i2 > 1024) {
            ...
            int i7 = 0;
            while (i6 < i4) {
                int SLE4428Cmd_Read8Bits = reader4428.SLE4428Cmd_Read8Bits(i3, 123, bArr3, iArr);
                if (SLE4428Cmd_Read8Bits != 0 || iArr[0] != 123) {
                    Log.e(TAG, "4428 read 8 bits failed: " + SLE4428Cmd_Read8Bits);
                    return null;
                }
                System.arraycopy(bArr3, 0, bArr2, i7, 123);
                i7 += 123;
                i3 += 123;
                i6++;
                bArr = null;
            ...
            if (i5 != 0) {
                int SLE4428Cmd_Read8Bits2 = reader4428.SLE4428Cmd_Read8Bits(i3, i5, bArr3, iArr);
                if (SLE4428Cmd_Read8Bits2 != 0 || iArr[0] != i5) {
                    Log.e(TAG, "4428 read 8 bits failed: " + SLE4428Cmd_Read8Bits2);
                    return bArr;
                }
                System.arraycopy(bArr3, 0, bArr2, i7, i5);
            }
            return bArr2;
        }
    }
