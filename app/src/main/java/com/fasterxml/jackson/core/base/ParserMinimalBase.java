...
public abstract class ParserMinimalBase extends JsonParser {
    ...
    protected void reportOverflowLong(String str, JsonToken jsonToken) throws IOException {
        _reportInputCoercion(String.format("Numeric value (%s) out of range of long (%d - %s)", _longIntegerDesc(str), Long.MIN_VALUE, Long.valueOf((long) LocationRequestCompat.PASSIVE_INTERVAL)), jsonToken, Long.TYPE);
    }
