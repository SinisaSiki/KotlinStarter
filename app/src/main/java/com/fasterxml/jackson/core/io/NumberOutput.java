...
public final class NumberOutput {
    ...
    static {
        ...
        sSmallIntStrs = new String[]{"0", "1", "2", "3", Configurator.SCREEN_BRIGHTNESS_83P, "5", Configurator.SCREEN_TIMEOUT_10_MIN, Configurator.SCREEN_TIMEOUT_30_MIN, "8", "9", "10"};
        sSmallIntStrs2 = new String[]{Configurator.SCREEN_TIMEOUT_NEVER, "-2", "-3", "-4", "-5", "-6", "-7", "-8", "-9", "-10"};
    }
