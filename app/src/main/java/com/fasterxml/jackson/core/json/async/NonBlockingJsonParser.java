...
public class NonBlockingJsonParser extends NonBlockingJsonParserBase implements ByteArrayFeeder {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0033, code lost:
        if (r2._parsingContext.inRoot() != false) goto L34;
     */
    ...
    */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:56:0x00f2 -> B:46:0x00c9). Please submit an issue!!! */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
            ...
            while (true) {
                if (i2 < min) {
                    ...
                    if (iArr[i6] == 0) {
                        ...
                        if (!_decodeSplitMultiByte(i6, i7, z)) {
                        ...
                        if (i8 == 1) {
                            ...
                            byte[] bArr2 = this._inputBuffer;
                            int i9 = i5 + 1;
                            i6 = _decodeUTF8_3(i6, bArr2[i5], bArr2[i9]);
                            i = i9 + 1;
                        } else if (i8 != 4) {
                            if (i6 < 32) {
                            ...
                            int i11 = i10 + 1;
                            int i12 = i11 + 1;
                            int _decodeUTF8_4 = _decodeUTF8_4(i6, bArr3[i5], bArr3[i10], bArr3[i11]);
