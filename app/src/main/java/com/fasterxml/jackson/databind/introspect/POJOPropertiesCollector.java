                ...
                if (equals || equals2) {
                    ...
                    if (modifyFieldName != null) {
                        ...
                        if (!z4 || propertyName2 != null || z2 || !Modifier.isFinal(annotatedField.getModifiers())) {
                            _property(map, modifyFieldName).addField(annotatedField, propertyName2, z, z3, z2);
                        }
                    }
                }
            }
    ...
    protected void _sortProperties(Map<String, POJOPropertyBuilder> map) {
        ...
        if (z || _anyIndexed || this._creatorProperties != null || findSerializationPropertyOrder != null) {
            ...
            if (_anyIndexed) {
                ...
                Iterator<Map.Entry<? extends Object, ? extends Object>> it2 = map2.entrySet().iterator();
                while (it2.hasNext()) {
