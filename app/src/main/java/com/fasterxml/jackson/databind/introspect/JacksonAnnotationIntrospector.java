        ...
        if (contentType != null) {
            ...
            if (contentType.hasRawClass(cls)) {
                ...
                try {
                    ...
                    throw _databindException(e3, String.format("Internal error: failed to refine value type of %s with concrete-type annotation (value %s), from '%s': %s", javaType, cls.getName(), annotated.getName(), e3.getMessage()));
                }
            }
    ...
    public JavaType refineDeserializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) throws JsonMappingException {
        ...
        if (contentType != null) {
            ...
            try {
                ...
                throw _databindException(e3, String.format("Failed to narrow value type of %s with concrete-type annotation (value %s), from '%s': %s", javaType, cls.getName(), annotated.getName(), e3.getMessage()));
            }
        }
        return javaType;
    }
